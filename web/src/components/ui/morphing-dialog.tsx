...
function MorphingDialogTrigger({
  ...
  return (
    <motion.div
      ...
      aria-controls={ariaControls ?? `motion-ui-morphing-dialog-content-${uniqueId}`}
      aria-expanded={ariaExpanded ?? isOpen}
      aria-haspopup={ariaHasPopup ?? 'dialog'}
      className={cn('relative cursor-pointer rounded-3xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25 focus-visible:ring-offset-2 focus-visible:ring-offset-background', className)}
      onClick={handleClick}
