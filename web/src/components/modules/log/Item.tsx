...
import { formatDateByLocale, formatNumberByLocale } from '@/lib/locale';
...
function formatTime(timestamp: number, locale: Parameters<typeof formatDateByLocale>[1]): string {
                        ...
                        <div className="min-w-0 flex flex-col gap-3">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-x-4 gap-y-2 text-xs tabular-nums text-muted-foreground">
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span>{t('input')} {formatNumberByLocale(log.input_tokens, locale)}</span>
                                </div>
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full min-h-0">
                                        <div className="flex flex-col rounded-2xl border border-border bg-muted/30 overflow-hidden min-h-0">
                                            <div className="flex items-center gap-2 px-3 md:px-4 py-2.5 md:py-3 border-b border-border bg-muted/50 shrink-0">
                                                ...
                                                <Badge variant="secondary" className="ml-auto text-xs">
                                                    {formatNumberByLocale(log.input_tokens, locale)} {t('tokens')}
                                                </Badge>
                                            </div>
                                        ...
                                        <div className="flex flex-col rounded-2xl border border-border bg-muted/30 overflow-hidden min-h-0">
                                            <div className="flex items-center gap-2 px-3 md:px-4 py-2.5 md:py-3 border-b border-border bg-muted/50 shrink-0">
                                                ...
                                                <Badge variant="secondary" className="ml-auto text-xs">
                                                    {formatNumberByLocale(log.output_tokens, locale)} {t('tokens')}
                                                </Badge>
                                            </div>
                                            <div className="flex-1 overflow-auto min-h-0">
