...
export function Total() {
    ...
    return (
        <div data-testid="home-total-section" className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-[18px]">
                            ...
                            <div key={idx} className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col min-w-0">
                                    ...
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-[1.35rem] leading-none md:text-[1.45rem]">
