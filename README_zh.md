...
```bash
docker run -d --name octopus -v /path/to/data:/app/data -p 1088:1088 ghcr.io/xiaoli0412/octopus-xiaoli-repo:v1.18.8
```
...
```bash
OCTOPUS_IMAGE=registry.example.com/octopus-xiaoli-repo:v1.18.8 bash install-octopus.sh
```
