...
const thinForwarderChecks = [
  {
    ...
    maxLines: 160,
    include: [
      "verify-backup-browser-smoke-cdp.ps1",
  ...
  {
    file: 'scripts/verify-backup-browser-smoke-cdp.ps1',
    maxLines: 110,
    include: [
      "verify-channel-create-browser-smoke-cdp.ps1",
      "[Alias('BrowserPath')]",
      '[string]$Browser',
      "NodeSmokeScript = 'scripts/verify-backup-browser-smoke-cdp.mjs'",
      "NodeSmokeSuccessMarker = 'backup-browser-smoke-cdp passed'",
      "SmokeLabel = 'backup'",
      "[string]$CdpPageBootstrapStrategy = 'attached-session'",
      "[string]$CdpBootstrapCommandOrder = 'page-lifecycle-runtime'",
      "if ($PSBoundParameters.ContainsKey('Browser')) { $forwardParams.BrowserPath = $Browser }",
