...
assert.match(channelIndexSource, /const channelDensity = useToolbarViewOptionsStore\(\(s\) => s\.channelDensity\);/);
assert.match(channelIndexSource, /data-testid="channel-page"/);
assert.match(channelIndexSource, /data-layout="grid"/);
assert.match(channelIndexSource, /data-density=\{channelDensity\}/);
...
assert.match(cardSource, /data-density=\{density\}/);
assert.match(cardSource, /const isCompact = density === 'compact';/);
...
assert.match(toolbarStoreSource, /export type CardDensity = 'normal' \| 'compact';/);
assert.match(toolbarStoreSource, /channelDensity: 'normal',/);
assert.match(toolbarStoreSource, /modelDensity: 'compact',/);
...
assert.match(toolbarStoreSource, /setChannelDensity: \(value\) => set\(\{ channelDensity: value \}\),/);
assert.match(toolbarStoreSource, /setModelDensity: \(value\) => set\(\{ modelDensity: value \}\),/);

assert.match(toolbarSource, /CHANNEL_PROVIDER_FILTER_OPTIONS/);
assert.match(toolbarSource, /channelProviderFilterLabelKeys/);
assert.match(toolbarSource, /const isDensityToolbar = toolbarItem === 'channel' \|\| toolbarItem === 'model';/);
assert.match(toolbarSource, /const activeDensity: CardDensity = toolbarItem === 'channel' \? channelDensity : modelDensity;/);
...
assert.match(toolbarSource, /setChannelDensity\(densityButtonMap\[value\]\);/);
assert.match(toolbarSource, /setModelDensity\(densityButtonMap\[value\]\);/);
